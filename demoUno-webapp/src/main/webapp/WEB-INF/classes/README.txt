...
This package contains:
   ...
   Magnolia Core 5.3
   Magnolia Internationalization Framework 5.3
   Magnolia JAAS 5.3
   Magnolia Imaging Module 3.1
   Magnolia Legacy UI 5.2.3
   magnolia-module-mail 5.1.3
   Magnolia Rendering 5.3
   Magnolia Templating 5.3
   Magnolia Templating for JSP 5.3
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.3.html
